...
class Spider:
    ...
    def __init__(self, name, head, path, q, start_page=1, end_page=1, resolution="2560x1080", atleast="atleast"):
        self.name = name
        self.head = head
        self.path = path
        self.q = q
    ...
    def get(self):
        ...
        for i in range(self.start_page, self.end_page + 1):
            url = f"https://wallhaven.cc/search?q={new_name}&categories=110&purity=100&{self.atleast}={self.resolution}&sorting=favorites&order=desc&page={i} "
...
def main():
    ...
    if set_pages == 1:
        ...
        if resolution == "" and (atleast == "" or atleast == "1"):
            spider = Spider(name, head, path, q, end_page=pages)
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        elif resolution == "" and atleast == "2":
            spider = Spider(name, head, path, q, end_page=pages, atleast="resolutions")
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        elif resolution != "" and (atleast == "" or atleast == "1"):
            spider = Spider(name, head, path, q, end_page=pages, resolution=resolution)
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        elif resolution != "" and atleast == "2":
            spider = Spider(name, head, path, q, end_page=pages, resolution=resolution, atleast="resolutions")
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        ...
        if resolution == "" and (atleast == "" or atleast == "1"):
            spider = Spider(name, head, path, q, start_pages, end_pages)
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        elif resolution == "" and atleast == "2":
            spider = Spider(name, head, path, q, start_pages, end_pages, atleast="resolutions")
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        elif resolution != "" and (atleast == "" or atleast == "1"):
            spider = Spider(name, head, path, q, start_pages, end_pages, resolution=resolution)
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
        elif resolution != "" and atleast == "2":
            spider = Spider(name, head, path, q, start_pages, end_pages, resolution=resolution, atleast="resolutions")
            t1 = threading.Thread(target=spider.get)
            t1.start()
            t2 = threading.Thread(target=spider.download)
            t2.start()
